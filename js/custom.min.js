var Frost = function() {
    ...
    /* Countdown Style 1 */
    var WebsiteLaunchDate = '16 July 2021 22:00';
    var handleCountDown = function(WebsiteLaunchDate) {
        /* Time Countr Down Js */
        if ($(".countdown").length) {
            $('.countdown').countdown({ date: WebsiteLaunchDate }, function() {
                // $('.countdown').text('Baby Neko Contract:0x0x0x0x0x0xx0x0x0xx0x0x0xx0x0x0x0x0x0x0x0x');
                $('.countdown').html('<div class="title-contract">Akio Neko Contract:</div><a href="https://exchange.pancakeswap.finance/#/swap?inputCurrency=0xDE3E537B2661bB47a3f928800B1C12acD4bb50B6">Buy Now!</a>');
            });
        }
