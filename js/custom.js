var Frost = function() {
    ...
    var WebsiteLaunchDate = '8 July 2021 10:00';
    ...
    var handleFinalCountDown = function() {
        if (jQuery('.countdown-timer').length > 0) {
            var startTime = new Date("July 12 2021 00:00:00"); // Put your website start time here
            startTime = startTime.getTime();

            var currentTime = new Date();
            currentTime = currentTime.getTime();

            var endTime = new Date("July 31 2021 12:00:37"); // Put your website end time here
